...
public class ReservationControllerWithMockServiceTest {
    ...
    void setup(){
        ...
        trip_fromLisboa_toPorto = new Trip(11L, route_fromLisboa_toPorto, Set.of(), 50, 25f, LocalDateTime.of(2024, 6, 2, 10, 15));
    ...
    void givenInvalidTrip_whenMakeReservation_thenReturnStatus404() {
        ...
        verify(reservationService, times(0)).makeReservation(any(ReservationDTO.class));
    }
    ...
    void givenValidFullTrip_whenMakeReservation_thenReturnStatus409() {
        ...
        when(reservationService.makeReservation(any(ReservationDTO.class))).thenReturn(Optional.empty());
        ...
        verify(tripService, times(1)).getTripById(anyLong());
        verify(reservationService, times(1)).makeReservation(any(ReservationDTO.class));
    }
    ...
    void givenValidNotFullTrip_whenMakeReservation_thenReturnReservation() {
        when(tripService.getTripById(anyLong())).thenReturn(Optional.of(trip_fromLisboa_toPorto));
        when(reservationService.makeReservation(any(ReservationDTO.class))).thenReturn(Optional.of(reservation_fromLisboa_toPorto));
