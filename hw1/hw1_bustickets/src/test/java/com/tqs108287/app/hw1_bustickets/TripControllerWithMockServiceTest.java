...
public class TripControllerWithMockServiceTest {
    ...
    void setup(){
        ...
        Leg leg_fromLisboa_toCoimbra = new Leg(1L, stop_lisboa, stop_coimbra, LocalTime.of(0, 23));
        Leg leg_fromLisboa_toAveiro = new Leg(2L, stop_lisboa, stop_aveiro, LocalTime.of(0, 23));
        Leg leg_fromCoimbra_toAveiro = new Leg(3L, stop_coimbra, stop_aveiro, LocalTime.of(0, 40));
        Leg leg_fromCoimbra_toPorto = new Leg(4L, stop_coimbra, stop_porto, LocalTime.of(0, 40));
        Leg leg_fromAveiro_toPorto = new Leg(5L, stop_aveiro, stop_porto, LocalTime.of(0, 33));
        Leg leg_fromAveiro_toBraga = new Leg(6L, stop_aveiro, stop_braga, LocalTime.of(0, 33));
